...
//        adapter.setSelected(POS_DASHBOARD);
        ...
        ImageView walk = findViewById(R.id.view);
//        ImageView charge = findViewById(R.id.charge);
...
//        LinearLayout button4 = findViewById(R.id.button4);
        LinearLayout button5 = findViewById(R.id.next_button);


        walk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent PieChartActivity = new Intent(v.getContext(), PieChartActivity.class);
...
//        androidx.fragment.app.Fragment selectedScreen = CenteredTextFragment.createFor(screenTitles[position]);
